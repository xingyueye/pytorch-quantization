...
import timm_urls_1 as timm_urls
...
def partial_quant(args):
    ...
    for k, v in timm_urls.timm_urls.items():
        ...
        PARTIAL_QUANT_FILENAME = 'partial_quant_demo_1.py'
        ...
        command_list = [sys.executable, PARTIAL_QUANT_FILENAME,
                        ...
                        '--save_qdq_onnx', '--drop_layers', str(skip_layer), '--calib_file_path', './test_results/calib_pth/']
