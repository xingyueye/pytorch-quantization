...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments, QuantArguments))
    ...
    metric = load_metric("squad_v2" if data_args.version_2_with_negative else "./metrics/squad")
