...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node 8 \
                                    ...
                                    --quant \
                                    --quant_config qat/configs/mpq_config_mobilenet.yaml \
                                    --pretrained_calib mobilenetv2_050_calib_128_w8a8_naive.pt \
                                    -b 512 \
                                    --sched step \
                                    --epochs 10 \
                                    --decay-epochs 2.4 \
                                    ...
                                    --amp \
                                    --val-split val \
                                    --output mobilenetv2_050_no_jitter_naive \
                                    --distillation-type soft \
                                    --distillation-scale 2000 \
                                    --teacher-model mobilenetv2_050 \
                                    --teacher-path https://s3plus.sankuai.com/automl-model-zoo/huyiming03/mbv3/mobilenetv2_050-3d30d450.pth