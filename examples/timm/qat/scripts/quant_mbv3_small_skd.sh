...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node 8 \
                                    ...
                                    --amp \
                                    --val-split val \
                                    --output mobilenetv3_small_075_no_jitter_naive \
                                    --distillation-type soft \
                                    --distillation-scale 2000 \
                                    --teacher-model mobilenetv3_small_075 \
                                    --teacher-path https://s3plus.sankuai.com/automl-model-zoo/huyiming03/mbv3/mobilenetv3_small_075_lambc-384766db.pth