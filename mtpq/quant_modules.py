...
_DEFAULT_QUANT_MAP = [_quant_entry(torch.nn, "Conv1d", quant_nn.QuantConv1d),
                      ...
                      _quant_entry(torch.nn, "MaxPool1d", quant_nn.QuantMaxPool1d),
                      _quant_entry(torch.nn, "MaxPool2d", quant_nn.QuantMaxPool2d),
                      _quant_entry(torch.nn, "MaxPool3d", quant_nn.QuantMaxPool3d),
...
def initialize(float_module_list=None, custom_quant_modules=None):
    ...
    Typical usage example:
        ...
        mtpq.quant_modules.initialize(float_module_list, custom_modules)
        ## Use the quantized modules
        mtpq.quant_modules.deactivate()
    """
