...
from mtpq.tensor_quant import fake_tensor_quant
from mtpq import nn as quant_nn
from mtpq import utils as quant_utils

__all__ = ["HistogramCalibrator", "calibrate_weights"]

class AsymHistogramCalibrator(_Calibrator):
    """Unified asymmetric histogram calibrator
    ...
    def __init__(self, num_bits, axis, unsigned, num_bins=2048, grow_method=None, skip_zeros=False, torch_hist=False):
        super(AsymHistogramCalibrator, self).__init__(num_bits, axis, unsigned)
        ...
        self._calib_bin_edges_minor = None
        self._calib_hist_minor = None
    ...
    def __repr__(self):
        s = "HistogramCalibrator("
        s += super(AsymHistogramCalibrator, self).__repr__()
